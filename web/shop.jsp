...
<jsp:useBean id="categoryBean" class="database.CategoryDAOBean" scope="request" />
            ...
            <section class="shop__filter">
                ...
                <div class="shop__filter-group">
                    ...
                    <div class="shop__filter-group-body">
                        <c:forEach items="${categoryBean.selectAll()}" var="category">
                            <div class="shop__filter-item">
                                <label for="manga" class="shop__filter-control">
                                    ...
                                    <a href="category?id=${category.id}">${category.categoryName}</a>
                                </label>
                            </div>
                        </c:forEach> 
                        <!--                    <div class="shop__filter-item">
                    ...
                    <form method="get" action="price">
                        <div class="shop__filter-group-body">
                            <div class="shop__filter-price">
                                <input type="text" name="min" id="" placeholder="MIN" class="shop__filter-price-input">
                                <input type="text" name="max" id="" placeholder="MAX" class="shop__filter-price-input">
                            </div>
                            <button class="shop__filter-price-btn normal" type="submit">Apply</button>
                        </div>
                    </form>
                </div>
            </section>
