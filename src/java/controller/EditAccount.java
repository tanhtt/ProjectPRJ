...
public class EditAccount extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Account newCustomer = new Account(customer.getUsername(),customer.getPassword(),customer.isIsUser(),fullname,gender,address,deliveryAddress,Date.valueOf(DOB),tel,email,"");;
